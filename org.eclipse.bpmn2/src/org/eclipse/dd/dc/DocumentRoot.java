	...
	extends EObject
{
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Bounds</em>' containment reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Bounds</em>' containment reference.
	 *
	 * @see        #setBounds(Bounds)
	 * @see        org.eclipse.dd.dc.DcPackage#getDocumentRoot_Bounds()
	 * @model      containment="true" upper="-2" transient="true" volatile="true" derived="true" extendedMetaData="kind='element' name='Bounds' namespace='http://www.omg.org/spec/DD/20100524/DC'"
	 * @generated
	 */
	Bounds getBounds();
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Font</em>' containment reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Font</em>' containment reference.
	 *
	 * @see        #setFont(Font)
	 * @see        org.eclipse.dd.dc.DcPackage#getDocumentRoot_Font()
	 * @model      containment="true" upper="-2" transient="true" volatile="true" derived="true" extendedMetaData="kind='element' name='Font' namespace='http://www.omg.org/spec/DD/20100524/DC'"
	 * @generated
	 */
	Font getFont();
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Point</em>' containment reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Point</em>' containment reference.
	 *
	 * @see        #setPoint(Point)
	 * @see        org.eclipse.dd.dc.DcPackage#getDocumentRoot_Point()
	 * @model      containment="true" upper="-2" transient="true" volatile="true" derived="true" extendedMetaData="kind='element' name='Point' namespace='http://www.omg.org/spec/DD/20100524/DC'"
	 * @generated
	 */
	Point getPoint();
