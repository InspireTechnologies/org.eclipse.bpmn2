	...
	extends Activity, FlowElementsContainer, InteractionNode
{
	...
	/**
	 * Returns the value of the '<em><b>Triggered By Event</b></em>' attribute. The default value is <code>"false"</code>.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Triggered By Event</em>' attribute isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      default="false" ordered="false" extendedMetaData="kind='attribute' name='triggeredByEvent'"
	 * @generated
	 */
