	...
	extends Diagram
{
	...
	/**
	 * Returns the value of the '<em><b>Label Style</b></em>' containment reference list. The list contents are of type {@link org.eclipse.bpmn2.di.BPMNLabelStyle}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Label Style</em>' containment reference list isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      containment="true" ordered="false" extendedMetaData="kind='element' name='BPMNLabelStyle' namespace='http://www.omg.org/spec/BPMN/20100524/DI'"
	 * @generated
	 */
	 ...
	 * @model      containment="true" required="true" ordered="false" extendedMetaData="kind='element' name='BPMNPlane' namespace='http://www.omg.org/spec/BPMN/20100524/DI'"
	 * @generated
	 */
	BPMNPlane getPlane();
