	...
	extends BaseElement
{
	...
	/**
	 * Returns the value of the '<em><b>Lanes</b></em>' containment reference list. The list contents are of type {@link org.eclipse.bpmn2.Lane}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Lanes</em>' containment reference list isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Lanes</em>' containment reference list.
	 *
	 * @see        org.eclipse.bpmn2.Bpmn2Package#getLaneSet_Lanes()
	 * @model      containment="true" ordered="false" extendedMetaData="kind='element' name='lane' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	List<Lane> getLanes();
