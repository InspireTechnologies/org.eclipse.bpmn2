	...
	extends CatchEvent
{
	...
	/**
	 * Returns the value of the '<em><b>Attached To Ref</b></em>' reference. It is bidirectional and its opposite is ' {@link org.eclipse.bpmn2.Activity#getBoundaryEventRefs <em>Boundary Event Refs</em>}'.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Attached To Ref</em>' reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      opposite="boundaryEventRefs" resolveProxies="false" required="true" ordered="false" extendedMetaData="kind='attribute' name='attachedToRef'"
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Cancel Activity</b></em>' attribute. The default value is <code>"true"</code>.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Cancel Activity</em>' attribute isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
