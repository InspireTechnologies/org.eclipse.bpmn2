	...
	implements DataObjectReference
{
	...
	public NotificationChain basicSetDataState( final DataState newDataState, NotificationChain msgs )
	{
		...
		{
			final ENotificationImpl notification = new ENotificationImpl( this, Notification.SET, Bpmn2Package.DATA_OBJECT_REFERENCE__DATA_STATE, oldDataState, newDataState );
	 ...
	 * @generated
	 */
	@Override public DataObject getDataObjectRef()
	{
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param      newDataObjectRef  DOCUMENT ME!
	 *
	 * @generated
	 */
	@Override public void setDataObjectRef( final DataObject newDataObjectRef )
	{
		final DataObject oldDataObjectRef = dataObjectRef;
