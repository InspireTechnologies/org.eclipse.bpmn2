	...
	extends Shape
{
	...
	/**
	 * Returns the value of the '<em><b>Owned Label</b></em>' reference list. The list contents are of type {@link org.eclipse.dd.di.Label}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Owned Label</em>' reference list isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
