	...
	extends Artifact
{
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Text</em>' attribute isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Text</em>' attribute.
	 *
	 * @see        #setText(String)
	 * @see        org.eclipse.bpmn2.Bpmn2Package#getTextAnnotation_Text()
	 * @model      required="true" ordered="false" extendedMetaData="kind='element' name='text' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	String getText();
	...
	/**
	 * Returns the value of the '<em><b>Text Format</b></em>' attribute. The default value is <code>"text/plain"</code>.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Text Format</em>' attribute isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      default="text/plain" ordered="false" extendedMetaData="kind='attribute' name='textFormat'"
	 * @generated
	 */
