	...
	extends EObject
{
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Extension Attribute Definition</em>' reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Value</b></em>' attribute list. The list contents are of type {@link org.eclipse.emf.ecore.util.FeatureMap.Entry}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Value</em>' containment reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @return     the value of the '<em>Value</em>' attribute list.
	 *
	 * @see        org.eclipse.bpmn2.Bpmn2Package#getExtensionAttributeValue_Value()
	 * @model      unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" extendedMetaData="kind='elementWildcard' wildcards='##other' name=':0' processing='lax'"
	 * @generated
	 */
	FeatureMap getValue();
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Value Ref</em>' reference isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
