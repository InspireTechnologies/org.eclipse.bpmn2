	...
	extends CatchEvent
{
	...
	/**
	 * Returns the value of the '<em><b>Is Interrupting</b></em>' attribute. The default value is <code>"true"</code>.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Is Interrupting</em>' attribute isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
