...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Multi Instance Behavior</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * @author     Harald
	...
	implements Enumerator
{
	 ...
	 * @generated
	 */
	private MultiInstanceBehavior( final int value, final String name, final String literal )
	{
		this.value   = value;
		this.name    = name;
	 ...
	 * @generated
	 */
	public static MultiInstanceBehavior get( final String literal )
	{
		for( int i = 0; i < VALUES_ARRAY.length; ++i )
		{
			final MultiInstanceBehavior result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static MultiInstanceBehavior get( final int value )
	{
		switch( value )
		{
			case NONE_VALUE :
	 ...
	 * @generated
	 */
	public static MultiInstanceBehavior getByName( final String name )
	{
		for( int i = 0; i < VALUES_ARRAY.length; ++i )
		{
			final MultiInstanceBehavior result = VALUES_ARRAY[i];
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of '<em><b>All</b></em>' literal object isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @see        #ALL
	 * @model      name="All"
	 * @generated
	 ...
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of '<em><b>Complex</b></em>' literal object isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 * @see        #COMPLEX
	 * @model      name="Complex"
	 * @generated
