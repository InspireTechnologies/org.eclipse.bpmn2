	...
	extends Switch<T>
{
	 ...
	 * @generated
	 */
	public T caseBounds( final Bounds object )
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFont( final Font object )
	{
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePoint( final Point object )
	{
		return null;
	}
	...
	@Override protected T doSwitch( final int classifierID, final EObject theEObject )
	{
		switch( classifierID )
		{
			...
			{
				final Bounds bounds = (Bounds) theEObject;
			...
			case DcPackage.FONT :
			{
				final Font font   = (Font) theEObject;
