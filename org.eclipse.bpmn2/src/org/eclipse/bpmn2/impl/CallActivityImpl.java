	...
	implements CallActivity
{
	 ...
	 * @generated
	 */
	@Override public CallableElement getCalledElementRef()
	{
		if(( calledElementRef != null ) && calledElementRef.eIsProxy())
		{
			final InternalEObject oldCalledElementRef = (InternalEObject) calledElementRef;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param      newCalledElementRef  DOCUMENT ME!
	 *
	 * @generated
	 */
	@Override public void setCalledElementRef( final CallableElement newCalledElementRef )
	{
		final CallableElement oldCalledElementRef = calledElementRef;
