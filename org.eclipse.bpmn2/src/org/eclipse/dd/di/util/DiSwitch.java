	...
	extends Switch<T>
{
	...
	@Override protected T doSwitch( final int classifierID, final EObject theEObject )
	{
		switch( classifierID )
		{
			...
			{
				final DiagramElement diagramElement = (DiagramElement) theEObject;
			...
			{
				final LabeledEdge labeledEdge = (LabeledEdge) theEObject;
			...
			{
				final LabeledShape labeledShape = (LabeledShape) theEObject;
			...
			{
				final Plane plane  = (Plane) theEObject;
