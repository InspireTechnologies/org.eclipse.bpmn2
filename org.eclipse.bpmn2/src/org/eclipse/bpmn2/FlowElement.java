	...
	extends BaseElement
{
	...
	/**
	 * Returns the value of the '<em><b>Category Value Ref</b></em>' reference list. The list contents are of type {@link org.eclipse.bpmn2.CategoryValue}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Category Value Ref</em>' reference list isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      ordered="false" extendedMetaData="kind='element' name='categoryValueRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
