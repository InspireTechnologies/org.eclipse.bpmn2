 ...
 * @generated
 */
public class BpmnDiAdapterFactory
	extends AdapterFactoryImpl
{
	...
	protected BpmnDiSwitch<Adapter> modelSwitch =
		new BpmnDiSwitch<Adapter>()
		{
			...
			@Override public Adapter caseBPMNDiagram( final BPMNDiagram object )
			{
				return createBPMNDiagramAdapter();
			}

			@Override public Adapter caseBPMNEdge( final BPMNEdge object )
			{
				return createBPMNEdgeAdapter();
			}

			@Override public Adapter caseBPMNLabel( final BPMNLabel object )
			{
				return createBPMNLabelAdapter();
			}

			@Override public Adapter caseBPMNLabelStyle( final BPMNLabelStyle object )
			{
				return createBPMNLabelStyleAdapter();
			}

			@Override public Adapter caseBPMNPlane( final BPMNPlane object )
			{
				return createBPMNPlaneAdapter();
			}

			@Override public Adapter caseBPMNShape( final BPMNShape object )
			{
				return createBPMNShapeAdapter();
			}

			@Override public Adapter caseDiagram( final Diagram object )
			{
				return createDiagramAdapter();
			}

			@Override public Adapter caseDiagramElement( final DiagramElement object )
			{
				return createDiagramElementAdapter();
			}

			@Override public Adapter caseEdge( final Edge object )
			{
				return createEdgeAdapter();
			}

			@Override public Adapter caseLabeledEdge( final LabeledEdge object )
			{
				return createLabeledEdgeAdapter();
			}

			@Override public Adapter caseNode( final Node object )
			{
				return createNodeAdapter();
			}

			@Override public Adapter caseLabel( final Label object )
			{
				return createLabelAdapter();
			}

			@Override public Adapter caseStyle( final Style object )
			{
				return createStyleAdapter();
			}

			@Override public Adapter casePlane( final Plane object )
			{
				return createPlaneAdapter();
			}

			@Override public Adapter caseShape( final Shape object )
			{
				return createShapeAdapter();
			}

			@Override public Adapter caseLabeledShape( final LabeledShape object )
			{
