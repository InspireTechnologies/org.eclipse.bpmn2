	...
	extends ChoreographyActivity
{
	...
	/**
	 * Returns the value of the '<em><b>Message Flow Ref</b></em>' reference list. The list contents are of type {@link org.eclipse.bpmn2.MessageFlow}.
	 * <!-- begin-user-doc -->
	 *
	 * <p>If the meaning of the '<em>Message Flow Ref</em>' reference list isn't clear, there really should be more of a description here...</p>
	 * <!-- end-user-doc -->
	 ...
	 * @model      required="true" upper="2" ordered="false" extendedMetaData="kind='element' name='messageFlowRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
